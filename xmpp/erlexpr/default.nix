# This is a copy of my implementation done for the Headcounter deployment[1]
# and it's a library to transform Nix expressions into Erlang expressions.
#
# [1]: https://github.com/headcounter/deployment/tree/c74d9b63a4aa7c/lib/erlang
lib:
